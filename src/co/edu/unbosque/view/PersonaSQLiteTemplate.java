...
import co.edu.unbosque.controller.PersonaComponentSQLite;
...
public class PersonaSQLiteTemplate extends JPanel {
  private static final long serialVersionUID = 1L;
  
  // Declaración servicios y objetos
  private PersonaComponentSQLite amigosComponent;
  ...
  public PersonaSQLiteTemplate(PersonaComponentSQLite amigosComponent) {
  ...
  public void crearContenidoPDatos() {
    ...
    lInstrucciones = sObjGraficos.construirJLabel(
      "<html>Informaci�n de la persona SQLite<html>",
      20, 10, 150, 50,
      null, null,
      sRecursos.getFontTitulo(),
      null,
